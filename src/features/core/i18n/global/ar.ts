...
export default {
  ...
  systemPages: {
    ...
    dashboardActionsProducts: "إدارة المنتجات",
    ...
    productsLead:
      "أدر كتالوج المنتجات الجاهزة للبيع بأسعار واضحة وتسميات ثنائية اللغة ورؤية دقيقة للعناصر النشطة في النظام.",
    productsCode: "كود المنتج",
    productsCodePlaceholder: "PRD-001",
    productsNameEn: "اسم المنتج (EN)",
    productsNameEnPlaceholder: "Signature Coffee Beans",
    productsNameAr: "اسم المنتج (AR)",
    ...
    editProductDescription: "حدّث تفاصيل هذا المنتج باللغتين مع السعر.",
    productCreated: "تم إنشاء المنتج.",
    productUpdated: "تم تحديث المنتج.",
    productSaveFailed: "تعذر حفظ المنتج.",
    productDeleted: "تمت أرشفة المنتج.",
    productDeleteFailed: "تعذر أرشفة المنتج.",
    productActivate: "تفعيل المنتج",
    productDeactivate: "تعطيل المنتج",
    ...
    productInfoDescription: "راجع هوية المنتج والسعر والحالة وبيانات التدقيق.",
    productNotFound: "المنتج غير موجود.",
    productCodeDuplicate: "يوجد منتج نشط آخر يستخدم هذا الكود.",
    productCopyCode: "نسخ الكود",
    productCodeCopied: "تم نسخ كود المنتج.",
  ...
  dataTable: {
    ...
    searchProductsHint: "ابحث بالكود أو اسم المنتج…",
