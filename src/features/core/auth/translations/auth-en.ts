...
export default {
  authTranslations: {
    ...
    unauthorized: dt(
      "You don't have permission to {action:enum} {resource:enum}",
      {
        enum: {
          action: {
            create: "create",
    ...
    oauth: {
      ...
      providerUnavailable: "{provider} sign-in is not currently available.",
    ...
    emails: {
      ...
      emailChangeVerification: {
        ...
        html: {
          intro:
            "You're changing your email from {currentEmail} to {newEmail}. Click the button below to confirm.",
          ignore:
            "If you didn't request this change, you can ignore this email.",
        },
    ...
    emailVerification: {
      ...
      notice: {
        ...
        missingEmail:
          "Add an email address first to enable email verification.",
      },
      error: {
        missingOrigin: "Unable to determine application URL",
        sendFailed:
