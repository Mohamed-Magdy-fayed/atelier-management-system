  ...
  authTranslations: {
    ...
    signUp: {
      ...
      error: {
        ...
        duplicate: "يوجد حساب لهذا البريد الإلكتروني مسبقاً، يرجى تسجيل الدخول",
    ...
    oauth: {
      ...
      connections: {
        ...
        description:
          "اربط أو افصل مزودي OAuth التي يمكنك استخدامها للوصول إلى حسابك.",
    ...
    passwordReset: {
      ...
      request: {
        ...
        emailError: "تعذر إرسال رمز الاستعادة. حاول مرة أخرى قريباً.",
      },
    },
    emails: {
      common: {
      ...
      passwordReset: {
        ...
        html: {
          intro:
            "تلقينا طلباً لإعادة تعيين كلمة المرور الخاصة بك. استخدم رمز التحقق أدناه في نموذج الاستعادة. ينتهي الرمز خلال {expiresIn} {minutesLabel}.",
      ...
      emailChangeVerification: {
        ...
        html: {
          intro:
            "أنت بصدد تغيير بريدك من {currentEmail} إلى {newEmail}. اضغط على الزر أدناه للتأكيد.",
          ignore: "إذا لم تطلب هذا التغيير، يمكنك تجاهل هذا البريد.",
        },
    ...
    emailVerification: {
      ...
      notice: {
        title: "تحقق من بريدك",
        description:
          "نستخدم هذا العنوان لاستعادة كلمة المرور والتنبيهات الأمنية.",
        sending: "جارٍ الإرسال...",
