...
import {
    AuthManagerDialogs,
} from "@/features/core/auth/nextjs/components/auth-manager/auth-manager-dialogs";
import {
    AuthManagerDropdown,
} from "@/features/core/auth/nextjs/components/auth-manager/auth-manager-dropdown";
