                        ...
                        {(isSubmitting) => (
                            ...
                            >
                                <LoadingSwap
                                    ...
                                    loadingText={t(
                                        "authTranslations.profile.form.saving",
                                    )}
                                >
                                    <SaveIcon />
                        ...
                        <FieldGroup>
                            ...
                            <form.AppField name="name">
                                {(field) => (
                                    <field.StringField
                                        label={t(
                                            "authTranslations.profile.name.label",
                                        )}
                                        placeholder={t(
                            ...
                            <form.AppField name="phone">
                                {(field) => (
                                    <field.MobileField
                                        label={t(
                                            "authTranslations.profile.phone.label",
                                        )}
                                        placeholder={t(
                            ...
                            <form.AppField name="imageUrl">
                                {(field) => (
                                    <field.ImageField
                                        label={t(
                                            "authTranslations.profile.imageUrl.label",
                                        )}
                                        placeholder={t(
                            ...
                            <form.AppField name="age">
                                {(field) => (
                                    <field.NumberField
                                        label={t(
                                            "authTranslations.profile.age.label",
                                        )}
                                        placeholder={t(
                                            "authTranslations.profile.age.placeholder",
                                        )}
                                    />
                                )}
                            </form.AppField>
