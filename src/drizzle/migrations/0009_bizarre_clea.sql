...
ALTER TABLE "branches" ADD COLUMN "shortCode" varchar(8) NOT NULL;--> statement-breakpoint
...
ALTER TABLE "branches" ADD COLUMN "mapUrl" varchar(2048);--> statement-breakpoint
...
CREATE INDEX "rental_customers_user_id_idx" ON "rental_customers" USING btree ("userId");--> statement-breakpoint
...
CREATE INDEX "settings_code_idx" ON "settings" USING btree ("code");--> statement-breakpoint
